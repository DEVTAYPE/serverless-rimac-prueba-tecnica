...
//  Adaptador MySQL para Chile — implementa ScheduleRepository.
//
//  Patrón Strategy: esta clase es la implementación concreta para CL.
//  Conecta al RDS MySQL de Chile mediante variables de entorno DB_CL_*.
//
//  appointments (RDS CL)
export class MySQLCLScheduleRepository implements IScheduleRepository {
  ...
  //  Persiste el agendamiento en la base de datos MySQL de Chile.
