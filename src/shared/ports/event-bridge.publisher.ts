...
//  EventBridge enruta el evento 'appointment-confirmed' → SQS de confirmación
//  → lambda appointment actualiza DynamoDB a 'completed'.
//
//        una vez que el evento appointment-confirmed sea procesado.
//  TODO: plus si da tiempo - implementar envío de correo de confirmación al asegurado
export interface IEventBridgePublisher {
  //  Publica un evento appointment-confirmed al bus de eventos default.
